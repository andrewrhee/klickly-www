...
module.exports = () ->
  # Only call grunt for devs, else package postinstall takes care of it
  env = process.env.NODE_ENV
  if env and env isnt 'development'
    return

  child = exec "#{__dirname}/../node_modules/grunt-cli/bin/grunt dev"
